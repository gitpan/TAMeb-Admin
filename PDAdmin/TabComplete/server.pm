package TAMeb::PDAdmin::TabComplete::server;
use strict;
use warnings;

use TAMeb::PDAdmin::TabComplete::utils;
use Data::Dumper;
...
sub _listServer {
    ...
    my $resp = TAMeb::Admin::Server->list($tam);
    unless ( $resp->isok ) {
...
sub _listTask {
	...
	my $server = TAMeb::Admin::Server->new($tam,name => $sname);
