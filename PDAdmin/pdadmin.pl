...
use warnings;
#---
# $Id: pdadmin.pl 291 2006-09-27 14:52:09Z mik $
#---

use TAMeb::Admin;
use Term::ReadKey;
use Text::ParseWords;
use TAMeb::PDAdmin::PDAdmin;
BEGIN {
    $ENV{PERL_RL} = 'Zoid';
}
...
sub dispatch {
    ...
    $func = 'iport' if $func eq 'import';
    my $nspace = "TAMeb::PDAdmin\:\:$grp\:\:$func";
    no strict 'refs';
...
$tam = TAMeb::Admin->new( userid => $uname, password => $pswd );
