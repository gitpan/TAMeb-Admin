package TAMeb::Admin::POP;
use strict;
use warnings;
use Carp;

#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# $Id: POP.pm 293 2006-09-27 14:54:09Z mik $
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$TAMeb::Admin::POP::VERSION = '0.06';
use Inline( C => 'DATA',
		INC  => '-I/opt/PolicyDirector/include',
                LIBS => ' -lpthread  -lpdadminapi -lstdc++',
		CCFLAGS => '-Wall',
		VERSION => '0.06',
	        NAME => 'TAMeb::Admin::POP',
	    );
...
sub find {
    my $self = shift;
    my $resp = TAMeb::Admin::Reponse->new;
...
L<TAMeb::Admin::POP> allows manipulation of POPs via perl.

=head1 CONSTRUCTORS

=head2 new( PDADMIN[, name =E<gt> NAME] )

Creates a blessed L<TAMeb::Admin::POP> object.  It should be noted that creating
...
An initialized L<TAMeb::Admin::Context> object.  This parameter is, as usual, required.
...
A blessed L<TAMeb::Admin::POP> object.  If there is an error, you will get
undef.
...
An initialized L<TAMeb::Admin::Context> object.  This parameter is required.
...
A L<TAMeb::Admin::Response> object containing the newly created object.  I refer
...
The standard, initialized L<TAMeb::Admin::Context> object.
...
All of the methods return a L<TAMeb::Admin::Response> object unless otherwise
...
L<TAMeb::Admin::ProtObject> object or a mix of them.
