package TAMeb::Admin::Response;
use strict;
use warnings;
use Carp;
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# $Id: Response.pm 296 2006-09-27 15:22:32Z mik $
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$TAMeb::Admin::Response::VERSION = '0.06';
use Inline(C => 'DATA',
		INC  => '-I/opt/PolicyDirector/include',
                LIBS => ' -lpthread  -lpdadminapi -lstdc++',
		CCFLAGS => '-g -Wall',
		VERSION => '0.06',
		NAME   => 'TAMeb::Admin::Response',
	  );
...
L<TAMeb::Admin::Response> is the general purpose object returned by just about
...
A fully blessed L<TAMeb::Admin::Response> object.
...
See L<TAMeb::Admin> for the list of all the people I am indebted to for their
