...
sub find {
    ...
    return TAMeb::Admin::ProtObject->find( $pd, authzrule => $self->name );
}
...
sub attach {
    ...
    for my $name ( @temp ) {
	my $obj = TAMeb::Admin::ProtObject->new($self->{context}, name => $name );
...
Creates a blessed B<TAMeb::Admin::AuthzRule> object and returns it.
...
An initializæd L<TAMeb::Admin::Context> object.  You should note that, once the
B<TAMeb::Admin::AuthzRule> object is instantiated, you cannot change the
context.
...
A fully blessed L<TAMeb::Admin::AuthzRule> object.  If you forget the
L<TAMeb::Admin::Context> object (which I can do with astonishing frequency),
L</new> returns undef.
...
As you would expect, this is a fully blessed L<TAMeb::Admin::Context> object.
...
It returns the fully blessed L<TAMeb::Admin::AuthzRule> object buried in a
...
A fully blessed L<TAMeb::Admin::AuthzRule> object. 
...
buried in a L<TAMeb::Admin::Response> object.
...
Please read L<TAMeb::Admin> for the full list of acks.  I stand upon the
shoulders of giants.
