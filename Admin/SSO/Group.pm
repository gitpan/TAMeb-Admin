...
TAMeb::Admin::SSO::Group

=head1 SYNOPSIS

=head1 DESCRIPTION

L<TAMeb::Admin::SSO::Group> provides the interface to modify, create and delete
GSO cred groups.
...
Initializes a blessed L<TAMeb::Admin::SSO::Group> object.
...
L<TAMeb::Admin::SSO::Cred> or L<TAMeb::Admin::SSO::Web> object.
...
create operation.  If it could be created, the new L<TAMeb::Admin::SSO::Group>
